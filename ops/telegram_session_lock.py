...
class TelegramSessionLock:
    ...
    def acquire(self) -> "TelegramSessionLock":
        ...
        try:
            ...
            # Bind both names after flock: the public parent pathname must still
            # name the directory descriptor used for the leaf open, and the leaf
            # pathname within that directory must still name this exact inode.
