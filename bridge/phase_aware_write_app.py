...
SEND_FILES external-effect seam. Private file-reference resolution and hash/size
revalidation happen before any Telegram mutating RPC; failures in that preflight
are therefore explicitly represented as proven no-side-effect failures. Once
