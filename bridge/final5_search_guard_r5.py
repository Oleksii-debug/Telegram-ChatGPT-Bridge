...
class GuardedTelethonReadBackend(TelethonReadBackend):
    ...
    async def _iter_messages(
        ...
        *,
        ...
        # Do not retry with a reduced argument set. TypeError may originate
        # inside a real Telethon call; dropping constraints would widen the
        # query or rescan an earlier page.
